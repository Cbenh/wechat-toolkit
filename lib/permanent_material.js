...
exports.updatePermanentNewsMaterial = updatePermanentNewsMaterial;
    ...
    fs.stat(filepath, function (err, stat) {
      ...
      if (err) {
        ...
        if (type === "video") {
          ...
          form.field('introduction', introduction);
        }
        ...
        //   console.log('all done!');
          // resolve({path: require('path').resolve(sails.config.appPath, "assets/tmp/" + name), url: url });
...
function updatePermanentNewsMaterial(access_token, mediaId, articles, articleIndex, callback) {
